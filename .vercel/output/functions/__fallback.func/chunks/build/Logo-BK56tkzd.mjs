...
const ipxRuntime$_1Kf_45VRkyU18buFUIGhiRdEBgk2W_dvOh1mR34QqdXvQ = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$_1Kf_45VRkyU18buFUIGhiRdEBgk2W_dvOh1mR34QqdXvQ, defaults: {} }
  }
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "logo" }, _attrs))} data-v-e828e0c6>`);
      _push(ssrRenderComponent(_component_nuxt_link, {
        to: "/",
        class: ["logo__wrapper", { "logo__wrapper--horizontal": __props.type === "horizontal" }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtImg, {
              src: "/assets/images/logo/DN-Project.png",
              alt: unref(project).projectName,
              class: "logo__preview",
              style: { width: __props.width },
              preload: "",
              loading: "lazy"
            }, null, _parent2, _scopeId));
            if (!__props.isTextHide) {
              _push2(`<div class="logo__box" data-v-e828e0c6${_scopeId}><p class="logo__text" data-v-e828e0c6${_scopeId}><span class="logo__baige" data-v-e828e0c6${_scopeId}></span> Project</p></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              !__props.isTextHide ? (openBlock(), createBlock("div", {
                key: 0,
                class: "logo__box"
              }, [
                createVNode("p", { class: "logo__text" }, [
                  createVNode("span", { class: "logo__baige" }),
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e828e0c6"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=Logo-BK56tkzd.mjs.map
