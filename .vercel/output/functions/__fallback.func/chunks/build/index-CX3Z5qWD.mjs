...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "lesson" }, _attrs))} data-v-7ef41d4d><div class="lesson__wrapper" data-v-7ef41d4d>`);
      if (unref(lesson)) {
        _push(ssrRenderComponent(_component_UiBreadcrumb, { info: unref(breadcrumb) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<h2 class="lesson__title" data-v-7ef41d4d>${ssrInterpolate(unref(lesson).name)}</h2>`);
      ...
      _push(`<div class="lesson__materials" data-v-7ef41d4d><p class="lesson__text" data-v-7ef41d4d>${ssrInterpolate(unref(t)("local.materials"))}:</p>`);
      if (unref(isConverting)) {
        _push(ssrRenderComponent(_component_UiLogo, null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<div id="conspectus" class="lesson__conspectus" data-v-7ef41d4d>${unref(lesson).content ?? ""}</div>`);
      ...
      _push(`</div><div class="lesson__btns" data-v-7ef41d4d><div class="lesson__btns-box" data-v-7ef41d4d><!--[-->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7ef41d4d"]]);

export { index as default };
//# sourceMappingURL=index-CX3Z5qWD.mjs.map
