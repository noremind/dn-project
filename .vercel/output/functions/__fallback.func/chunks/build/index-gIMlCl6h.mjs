...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><section class="test" data-v-2c7cda93><div class="test__wrapper" data-v-2c7cda93><div class="test__top" data-v-2c7cda93>`);
      _push(ssrRenderComponent(_component_UiButton, {
        class: "secondary-btn",
      ...
      _push(`<h2 class="test__title" data-v-2c7cda93>${ssrInterpolate(unref(test)?.title)}</h2></div><div class="test__box" data-v-2c7cda93><div class="test__content" data-v-2c7cda93>`);
      ...
      _push(`<div class="test__btns" data-v-2c7cda93>`);
      ...
      _push(`</div><div class="test__info" data-v-2c7cda93>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2c7cda93"]]);

export { index as default };
//# sourceMappingURL=index-gIMlCl6h.mjs.map
